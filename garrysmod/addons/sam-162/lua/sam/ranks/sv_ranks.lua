...
function sam.ranks.remove_rank(name)
	...
	// 2deae110c62239c3785343abc9fe2e4608c4b29e7dc709f005dfbf09d80342e2
...
function sam.ranks.change_inherit(name, inherit)
	...
	-- 095b5b8928c632a44e5e0a7b562f8885684564af6d9210bad839b170f142e78f!!!
...
function sam.ranks.change_immunity(name, new_immunity)
	...
	new_immunity = math.Clamp(new_immunity, 2, 99) // 94d86e714be52d3b5430cddf75f267fa0716ce60edfc7462ce593b7df13105d7!!!
...
function sam.ranks.give_permission(name, permission)
	...
	-- ddd38aa5a7a84de0223ac8713f1fd753602297439371f3363a0ba9d871a1fcf7!!!
...
hook.Add("SAM.DatabaseLoaded", "LoadRanks", function()
	SQL.Query([[
		...
		if #ranks < 3 then
			...
			/*ea3040d602f10c8bba6d2ba898a58fd47f0579ee0ebff04b80613c0bc74a9a09*/
		end
